...
public class DataServiceLocator {
    ...
    private static final String BASE_SERVER_URL = "http://52.37.176.22:8011/BVServer";
    // private static final String BASE_SERVER_URL = "http://10.0.0.10:8011/BVServer";
    ...
    private static final String DEMO_BOOKS_3_FOLDER = "https://googledrive.com/host/0B1vAOgyjy-9lNWl1SzM5QWMwNHc";

    //// Net download data.
    private static final String NET_FOLDER = DEMO_BOOKS_3_FOLDER;
